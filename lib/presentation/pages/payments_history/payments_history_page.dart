...
import 'package:rick_and_morty_api/core/dictionaries/styles.dart';
import 'package:rick_and_morty_api/data/contracts_data/contract_model/contract_model.dart';
import 'package:rick_and_morty_api/presentation/pages/contract_info_page.dart';
import 'package:rick_and_morty_api/presentation/pages/payments_history/payment_full_info.dart';
...
class _PaymentsHistoryState extends ConsumerState<PaymentsHistory> with TickerProviderStateMixin, ShowableBottomPayOneSheet {
  ...
  Widget _body(List<PaymentsHistoryModel> history, ContractModel contract) {
    ...
    var dateArray = dateArr(history);
    return Padding(
      padding: EdgeInsets.only(left: 16.w, right: 16.w, bottom: 12.h, top: 6.h),
      child: Column(
