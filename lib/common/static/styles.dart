...
class AppStyles {
  ...
  static TextStyle headerTitle() =>
      _basicFont().copyWith(fontSize: 18.sp, fontWeight: FontWeight.w500);
  ...
  // Figma - Цифры таймер
  static TextStyle alertNumber() =>
      _basicFont().copyWith(fontSize: 50.sp, fontWeight: FontWeight.w500);
  ...
  static TextStyle body1() =>
      _basicFont().copyWith(fontSize: 15.sp, fontWeight: FontWeight.w300);
